...
;; this is modified and copied from core.cache because wrapped didn't work
;; in the packaged core.cache for some reason ....

(ns daily-goal-app.cache
...
(defn through
  ...
  ([wrap-fn value-fn cache-atom item]
   (swap! cache-atom through-cache-c item wrap-fn value-fn)))
